    ...
    window.addEventListener("message", function (event) {
        ...
        else
        {
            if (event.data.text == "Locked") {
                event.data.text = '<i style="color:red" class="fas fa-lock"><br>Locked</i>'
            } else if (event.data.text == "Unlocked") {
                event.data.text = '<i style="color:limegreen" class="fas fa-unlock"><br>Open</i>'
            } else if (event.data.text == "Locking") {
                event.data.text = '<i style="color:orange" class="fas fa-lock"><br>the door is locking</i>'
            }
